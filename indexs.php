...
<html>
	<head>
		<title>Remote Syslog: v2.0.1</title>
	</head>
	<body bgcolor="#000000"; style="color:#00FF00">

        </script>
                <div style="width:100%;">
                                <?php echo "<font color=\"white\">Remote Syslog v2.0.1<br>More info: </font>"; ?><a href="https://www.remotesyslog.com/" target="_blank" style="color: #FFFF00">https://www.remotesyslog.com/</a>
